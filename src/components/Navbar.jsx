...
import jme_logo from '../assets/jme_logo.png';
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <img src={jme_logo} alt="logo" className="w-9 h-9 object-contain" />
          <p className="text-white text-[18px] font-bold cursor-pointer flex"> 
          Jamie Shing Him Ho &nbsp; 
          <span className="sm:block hidden"> | Biomedical Engineering (MEng)</span></p>
        </Link>
